...
class Debug final {
 public:
  ...
  typedef WithAsyncMethod_Get<WithAsyncMethod_RaftLog<WithAsyncMethod_RegionInfo<WithAsyncMethod_RegionSize<WithAsyncMethod_ScanMvcc<WithAsyncMethod_Compact<WithAsyncMethod_InjectFailPoint<WithAsyncMethod_RecoverFailPoint<WithAsyncMethod_ListFailPoints<WithAsyncMethod_GetMetrics<WithAsyncMethod_CheckRegionConsistency<WithAsyncMethod_ModifyTikvConfig<Service > > > > > > > > > > > > AsyncService;
  template <class BaseClass>
  ...
  typedef WithStreamedUnaryMethod_Get<WithStreamedUnaryMethod_RaftLog<WithStreamedUnaryMethod_RegionInfo<WithStreamedUnaryMethod_RegionSize<WithStreamedUnaryMethod_Compact<WithStreamedUnaryMethod_InjectFailPoint<WithStreamedUnaryMethod_RecoverFailPoint<WithStreamedUnaryMethod_ListFailPoints<WithStreamedUnaryMethod_GetMetrics<WithStreamedUnaryMethod_CheckRegionConsistency<WithStreamedUnaryMethod_ModifyTikvConfig<Service > > > > > > > > > > > StreamedUnaryService;
  template <class BaseClass>
  ...
  typedef WithStreamedUnaryMethod_Get<WithStreamedUnaryMethod_RaftLog<WithStreamedUnaryMethod_RegionInfo<WithStreamedUnaryMethod_RegionSize<WithSplitStreamingMethod_ScanMvcc<WithStreamedUnaryMethod_Compact<WithStreamedUnaryMethod_InjectFailPoint<WithStreamedUnaryMethod_RecoverFailPoint<WithStreamedUnaryMethod_ListFailPoints<WithStreamedUnaryMethod_GetMetrics<WithStreamedUnaryMethod_CheckRegionConsistency<WithStreamedUnaryMethod_ModifyTikvConfig<Service > > > > > > > > > > > > StreamedService;
};
