...
class PD final {
 public:
  ...
  typedef WithAsyncMethod_GetMembers<WithAsyncMethod_Tso<WithAsyncMethod_Bootstrap<WithAsyncMethod_IsBootstrapped<WithAsyncMethod_AllocID<WithAsyncMethod_GetStore<WithAsyncMethod_PutStore<WithAsyncMethod_GetAllStores<WithAsyncMethod_StoreHeartbeat<WithAsyncMethod_RegionHeartbeat<WithAsyncMethod_GetRegion<WithAsyncMethod_GetRegionByID<WithAsyncMethod_AskSplit<WithAsyncMethod_ReportSplit<WithAsyncMethod_GetClusterConfig<WithAsyncMethod_PutClusterConfig<WithAsyncMethod_ScatterRegion<Service > > > > > > > > > > > > > > > > > AsyncService;
  template <class BaseClass>
  ...
  typedef WithStreamedUnaryMethod_GetMembers<WithStreamedUnaryMethod_Bootstrap<WithStreamedUnaryMethod_IsBootstrapped<WithStreamedUnaryMethod_AllocID<WithStreamedUnaryMethod_GetStore<WithStreamedUnaryMethod_PutStore<WithStreamedUnaryMethod_GetAllStores<WithStreamedUnaryMethod_StoreHeartbeat<WithStreamedUnaryMethod_GetRegion<WithStreamedUnaryMethod_GetRegionByID<WithStreamedUnaryMethod_AskSplit<WithStreamedUnaryMethod_ReportSplit<WithStreamedUnaryMethod_GetClusterConfig<WithStreamedUnaryMethod_PutClusterConfig<WithStreamedUnaryMethod_ScatterRegion<Service > > > > > > > > > > > > > > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_GetMembers<WithStreamedUnaryMethod_Bootstrap<WithStreamedUnaryMethod_IsBootstrapped<WithStreamedUnaryMethod_AllocID<WithStreamedUnaryMethod_GetStore<WithStreamedUnaryMethod_PutStore<WithStreamedUnaryMethod_GetAllStores<WithStreamedUnaryMethod_StoreHeartbeat<WithStreamedUnaryMethod_GetRegion<WithStreamedUnaryMethod_GetRegionByID<WithStreamedUnaryMethod_AskSplit<WithStreamedUnaryMethod_ReportSplit<WithStreamedUnaryMethod_GetClusterConfig<WithStreamedUnaryMethod_PutClusterConfig<WithStreamedUnaryMethod_ScatterRegion<Service > > > > > > > > > > > > > > > StreamedService;
};
